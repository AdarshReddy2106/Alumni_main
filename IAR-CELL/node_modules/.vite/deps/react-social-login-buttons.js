...
var require_dist = __commonJS({
  "node_modules/react-social-login-buttons/dist/index.js"(exports, module) {
    ...
    var Icon = ({ name, size, format }) => {
      return import_react.default.createElement("i", { className: format(name), style: { fontSize: size } });
    };
    var icon_default = Icon;
    var import_react2 = __toESM(require_react());
    var DynamicIcon = ({ type: Component, size, format, color = "#FFFFFF" }) => {
      const renderIElement = typeof Component === "string";
      return renderIElement ? import_react2.default.createElement(icon_default, __spreadValues({}, { format, name: Component, size })) : import_react2.default.createElement(Component, { size, color });
    };
    ...
    var SocialLoginButton = (props) => {
      ...
      return import_react3.default.createElement(
        ...
        import_react3.default.createElement("div", { style: styles.flex }, !isZeroPx(iconSize) && !!icon && import_react3.default.createElement(
          "div",
          {
            style: {
              display: "flex",
          ...
          import_react3.default.createElement(DynamicIcon, { type: icon, size: iconSize, format: iconFormat, color: iconColor })
        ), !isZeroPx(iconSize) && import_react3.default.createElement("div", { style: styles.divider }), import_react3.default.createElement("div", { style: { textAlign: align, width: "100%" } }, children))
      );
    };
    ...
    var createButton = (config21) => (props) => {
      ...
      return import_react4.default.createElement(SocialLoginButton, __spreadValues({}, finalProps));
    };
    var config = {
    ...
    function Icon2({ size, color }) {
      return import_react5.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, viewBox: "0 0 90 90" }, import_react5.default.createElement("g", null, import_react5.default.createElement(
        "path",
        {
    ...
    function Icon3({ size }) {
      return import_react6.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 64 64", width: size, height: size }, import_react6.default.createElement(
        "linearGradient",
        {
        ...
        import_react6.default.createElement("stop", { offset: "0", stopColor: "#ff5840" }),
        import_react6.default.createElement("stop", { offset: ".007", stopColor: "#ff5840" }),
        import_react6.default.createElement("stop", { offset: ".989", stopColor: "#fa528c" }),
        import_react6.default.createElement("stop", { offset: "1", stopColor: "#fa528c" })
        ...
        import_react6.default.createElement("stop", { offset: "0", stopColor: "#feaa53" }),
        import_react6.default.createElement("stop", { offset: ".612", stopColor: "#ffcd49" }),
        import_react6.default.createElement("stop", { offset: "1", stopColor: "#ffde44" })
      ), import_react6.default.createElement(
        "path",
        {
        ...
        import_react6.default.createElement("stop", { offset: "0", stopColor: "#42d778" }),
        import_react6.default.createElement("stop", { offset: ".428", stopColor: "#3dca76" }),
        import_react6.default.createElement("stop", { offset: "1", stopColor: "#34b171" })
      ), import_react6.default.createElement(
        "path",
        {
        ...
        import_react6.default.createElement("stop", { offset: "0", stopColor: "#155cde" }),
        import_react6.default.createElement("stop", { offset: ".278", stopColor: "#1f7fe5" }),
        import_react6.default.createElement("stop", { offset: ".569", stopColor: "#279ceb" }),
        import_react6.default.createElement("stop", { offset: ".82", stopColor: "#2cafef" }),
        import_react6.default.createElement("stop", { offset: "1", stopColor: "#2eb5f0" })
      ), import_react6.default.createElement(
        "path",
        {
    ...
    function Icon4({ size, color }) {
      return import_react7.default.createElement("svg", { fill: color, role: "img", viewBox: "0 0 24 24", width: size, height: size, xmlns: "http://www.w3.org/2000/svg" }, import_react7.default.createElement("path", { d: "M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12" }));
    }
    ...
    function Icon5({ size, color }) {
      return import_react8.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, viewBox: "0 0 24 24" }, import_react8.default.createElement(
        "path",
        {
          fill: color,
    ...
    function Icon6({ size, color }) {
      return import_react9.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: color, width: size, height: size, viewBox: "0 0 24 24" }, import_react9.default.createElement(
        "path",
        {
    ...
    function Icon7({ size, color }) {
      return import_react10.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, viewBox: "0 0 169.063 169.063" }, import_react10.default.createElement("g", { fill: color }, import_react10.default.createElement("path", { d: "M122.406,0H46.654C20.929,0,0,20.93,0,46.655v75.752c0,25.726,20.929,46.655,46.654,46.655h75.752   c25.727,0,46.656-20.93,46.656-46.655V46.655C169.063,20.93,148.133,0,122.406,0z M154.063,122.407   c0,17.455-14.201,31.655-31.656,31.655H46.654C29.2,154.063,15,139.862,15,122.407V46.655C15,29.201,29.2,15,46.654,15h75.752   c17.455,0,31.656,14.201,31.656,31.655V122.407z" }), import_react10.default.createElement("path", { d: "M84.531,40.97c-24.021,0-43.563,19.542-43.563,43.563c0,24.02,19.542,43.561,43.563,43.561s43.563-19.541,43.563-43.561   C128.094,60.512,108.552,40.97,84.531,40.97z M84.531,113.093c-15.749,0-28.563-12.812-28.563-28.561   c0-15.75,12.813-28.563,28.563-28.563s28.563,12.813,28.563,28.563C113.094,100.281,100.28,113.093,84.531,113.093z" }), import_react10.default.createElement("path", { d: "M129.921,28.251c-2.89,0-5.729,1.17-7.77,3.22c-2.051,2.04-3.23,4.88-3.23,7.78c0,2.891,1.18,5.73,3.23,7.78   c2.04,2.04,4.88,3.22,7.77,3.22c2.9,0,5.73-1.18,7.78-3.22c2.05-2.05,3.22-4.89,3.22-7.78c0-2.9-1.17-5.74-3.22-7.78   C135.661,29.421,132.821,28.251,129.921,28.251z" })));
    }
    ...
    function Icon8({ size, color }) {
      return import_react11.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, viewBox: "0 0 430.117 430.117" }, import_react11.default.createElement("g", null, import_react11.default.createElement(
        "path",
        {
    ...
    function Icon9({ size, color }) {
      return import_react12.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: color, x: "0px", y: "0px", viewBox: "0 0 48 48" }, import_react12.default.createElement("path", { fill: "#ff5722", d: "M6 6H22V22H6z", transform: "rotate(-180 14 14)" }), import_react12.default.createElement("path", { fill: "#4caf50", d: "M26 6H42V22H26z", transform: "rotate(-180 34 14)" }), import_react12.default.createElement("path", { fill: "#ffc107", d: "M26 26H42V42H26z", transform: "rotate(-180 34 34)" }), import_react12.default.createElement("path", { fill: "#03a9f4", d: "M6 26H22V42H6z", transform: "rotate(-180 14 34)" }));
    }
    ...
    function Icon11({ size }) {
      return import_react14.default.createElement(
        ...
        import_react14.default.createElement("defs", null, import_react14.default.createElement("linearGradient", { id: "b", x1: ".66", x2: ".851", y1: ".437", y2: ".802" }, import_react14.default.createElement("stop", { offset: "0", stopColor: "#eff7fc" }), import_react14.default.createElement("stop", { offset: "1", stopColor: "#fff" }))),
        import_react14.default.createElement("circle", { cx: "120", cy: "120", r: "120", fill: "url(#a)" }),
        import_react14.default.createElement("path", { fill: "#c8daea", d: "M98 175c-3.888 0-3.227-1.468-4.568-5.17L82 132.207 170 80" }),
        import_react14.default.createElement("path", { fill: "#a9c9dd", d: "M98 175c3 0 4.325-1.372 6-3l16-15.558-19.958-12.035" }),
    ...
    function Icon12({ size }) {
      return import_react15.default.createElement(
        ...
        import_react15.default.createElement("g", { stroke: "none", strokeWidth: "1", fill: "none", fillRule: "evenodd" }, import_react15.default.createElement(
          "path",
          {
    ...
    function Icon13({ size, color }) {
      return import_react16.default.createElement("svg", { role: "img", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", fill: color, width: size, height: size }, import_react16.default.createElement("title", null, "Discord icon"), import_react16.default.createElement("path", { d: "M20.222 0c1.406 0 2.54 1.137 2.607 2.475V24l-2.677-2.273-1.47-1.338-1.604-1.398.67 2.205H3.71c-1.402 0-2.54-1.065-2.54-2.476V2.48C1.17 1.142 2.31.003 3.715.003h16.5L20.222 0zm-6.118 5.683h-.03l-.202.2c2.073.6 3.076 1.537 3.076 1.537-1.336-.668-2.54-1.002-3.744-1.137-.87-.135-1.74-.064-2.475 0h-.2c-.47 0-1.47.2-2.81.735-.467.203-.735.336-.735.336s1.002-1.002 3.21-1.537l-.135-.135s-1.672-.064-3.477 1.27c0 0-1.805 3.144-1.805 7.02 0 0 1 1.74 3.743 1.806 0 0 .4-.533.805-1.002-1.54-.468-2.14-1.404-2.14-1.404s.134.066.335.2h.06c.03 0 .044.015.06.03v.006c.016.016.03.03.06.03.33.136.66.27.93.4.466.202 1.065.403 1.8.536.93.135 1.996.2 3.21 0 .6-.135 1.2-.267 1.8-.535.39-.2.87-.4 1.397-.737 0 0-.6.936-2.205 1.404.33.466.795 1 .795 1 2.744-.06 3.81-1.8 3.87-1.726 0-3.87-1.815-7.02-1.815-7.02-1.635-1.214-3.165-1.26-3.435-1.26l.056-.02zm.168 4.413c.703 0 1.27.6 1.27 1.335 0 .74-.57 1.34-1.27 1.34-.7 0-1.27-.6-1.27-1.334.002-.74.573-1.338 1.27-1.338zm-4.543 0c.7 0 1.266.6 1.266 1.335 0 .74-.57 1.34-1.27 1.34-.7 0-1.27-.6-1.27-1.334 0-.74.57-1.338 1.27-1.338z" }));
    }
    ...
    function Icon14({ size }) {
      return import_react17.default.createElement(
        ...
        import_react17.default.createElement("g", null, import_react17.default.createElement("g", null, import_react17.default.createElement(
          "path",
          {
            fill: "#007DC1",
        ...
        import_react17.default.createElement("g", null, import_react17.default.createElement(
          "path",
          {
            fill: "#007DC1",
    ...
    function Icon15({ size, color }) {
      return import_react18.default.createElement(
        ...
        import_react18.default.createElement("g", { clipRule: "evenodd", fillRule: "evenodd" }, import_react18.default.createElement(
          "path",
          {
    ...
    function Icon16({ size, color }) {
      return import_react19.default.createElement(
        ...
        import_react19.default.createElement("g", null, import_react19.default.createElement(
          "path",
          {
            fill: "transparent",
    ...
    function Icon17({ size, color }) {
      return import_react20.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, viewBox: "0 0 24 24" }, import_react20.default.createElement(
        "path",
        {
          fill: color,
    ...
    function Icon18({ size, color }) {
      return import_react21.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: color, viewBox: "0 0 512 512" }, import_react21.default.createElement("path", { d: "M412.19 118.66a109.27 109.27 0 01-9.45-5.5 132.87 132.87 0 01-24.27-20.62c-18.1-20.71-24.86-41.72-27.35-56.43h.1C349.14 23.9 350 16 350.13 16h-82.44v318.78c0 4.28 0 8.51-.18 12.69 0 .52-.05 1-.08 1.56 0 .23 0 .47-.05.71v.18a70 70 0 01-35.22 55.56 68.8 68.8 0 01-34.11 9c-38.41 0-69.54-31.32-69.54-70s31.13-70 69.54-70a68.9 68.9 0 0121.41 3.39l.1-83.94a153.14 153.14 0 00-118 34.52 161.79 161.79 0 00-35.3 43.53c-3.48 6-16.61 30.11-18.2 69.24-1 22.21 5.67 45.22 8.85 54.73v.2c2 5.6 9.75 24.71 22.38 40.82A167.53 167.53 0 00115 470.66v-.2l.2.2c39.91 27.12 84.16 25.34 84.16 25.34 7.66-.31 33.32 0 62.46-13.81 32.32-15.31 50.72-38.12 50.72-38.12a158.46 158.46 0 0027.64-45.93c7.46-19.61 9.95-43.13 9.95-52.53V176.49c1 .6 14.32 9.41 14.32 9.41s19.19 12.3 49.13 20.31c21.48 5.7 50.42 6.9 50.42 6.9v-81.84c-10.14 1.1-30.73-2.1-51.81-12.61z" }));
    }
    ...
    function Icon20({ size, color }) {
      return import_react23.default.createElement("svg", { fill: color, role: "img", viewBox: "0 0 24 24", width: size, height: size, xmlns: "http://www.w3.org/2000/svg" }, import_react23.default.createElement("path", { d: "M21.94 13.11L20.89 9.89C20.89 9.86 20.88 9.83 20.87 9.8L18.76 3.32C18.65 3 18.33 2.75 17.96 2.75C17.6 2.75 17.28 3 17.17 3.33L15.17 9.5H8.84L6.83 3.33C6.72 3 6.4 2.75 6.04 2.75H6.04C5.67 2.75 5.35 3 5.24 3.33L3.13 9.82C3.13 9.82 3.13 9.83 3.13 9.83L2.06 13.11C1.9 13.61 2.07 14.15 2.5 14.45L11.72 21.16C11.89 21.28 12.11 21.28 12.28 21.15L21.5 14.45C21.93 14.15 22.1 13.61 21.94 13.11M8.15 10.45L10.72 18.36L4.55 10.45M13.28 18.37L15.75 10.78L15.85 10.45H19.46L13.87 17.61M17.97 3.94L19.78 9.5H16.16M14.86 10.45L13.07 15.96L12 19.24L9.14 10.45M6.03 3.94L7.84 9.5H4.23M3.05 13.69C2.96 13.62 2.92 13.5 2.96 13.4L3.75 10.97L9.57 18.42M20.95 13.69L14.44 18.42L14.46 18.39L20.25 10.97L21.04 13.4C21.08 13.5 21.04 13.62 20.95 13.69" }));
    }
    ...
    function Icon21({ size, color }) {
      return import_react24.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, viewBox: "0 0 24 24" }, import_react24.default.createElement(
        "path",
        {
          fill: color,
          d: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"
