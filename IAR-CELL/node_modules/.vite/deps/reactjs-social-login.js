...
var m = (0, import_react.memo)(function(t2) {
  ...
  var Q = (0, import_react.useCallback)(function() {
    ...
    } else fetch("https://www.googleapis.com/oauth2/v3/tokeninfo?id_token=" + e2.credential, { method: "GET" }).then(function(e3) {
      return e3.json();
    }).then(function(t4) {
      var o2 = c({}, e2, t4);
      L({ provider: "google", data: o2 });
    ...
    Q() ? K(true) : V(document, "script", "google-login", "https://accounts.google.com/gsi/client", function() {
      ...
      if ("idToken" === v2) h.google.accounts.id.initialize(c({}, e2, { auto_select: T, prompt: "select_account", login_uri: E, callback: X, native_callback: X, error_callback: Y }));
      else {
...
var v = (0, import_react.memo)(function(t2) {
  ...
  var j = (0, import_react.useCallback)(function(e2) {
    ...
    if (k2) P({ provider: "github", data: { code: e2 } });
    else {
        ...
        for (var t4, o4 = {}, n3 = function(e4, t5) {
          ...
          if ("undefined" == typeof Symbol || null == e4[Symbol.iterator]) {
            if (Array.isArray(e4) || (o5 = function(e5, t6) {
              if (e5) {
                if ("string" == typeof e5) return a(e5, void 0);
...
var f = (0, import_react.memo)(function(t2) {
  ...
  var j = (0, import_react.useCallback)(function(e2) {
    ...
    if (_2) P({ provider: "instagram", data: { code: e2 } });
    else {
...
var g = (0, import_react.memo)(function(t2) {
  ...
  var z = (0, import_react.useCallback)(function(e2) {
    ...
    if (j) N({ provider: "microsoft", data: { code: e2 } });
    else {
...
var w = (0, import_react.memo)(function(t2) {
  ...
  var L = (0, import_react.useCallback)(function(e2) {
    ...
    if (w2) P({ provider: "linkedin", data: { code: e2 } });
    else {
    ...
    try {
      ...
      var e2 = function() {
        if (k.AppleID) {
          ...
          if (e3 && e3.then) return e3.then(function() {
          });
        } else L(), p2("Apple SDK isn't loaded!");
      }();
